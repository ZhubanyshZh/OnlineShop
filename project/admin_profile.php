                ...
                <main>
                    ...
                    <div class="datatable-container">
                        <table id="datatablesSimple" class="datatable-table">
                            <thead>
                                <tr>
                                    <th data-sortable="true"><a href="#" class="datatable-sorter">ID</a></th>
                                    <th data-sortable="true"><a href="#" class="datatable-sorter">Name</a></th>
                                    <th data-sortable="true"><a href="#" class="datatable-sorter">Phone_Number</a></th>
                                    <th data-sortable="true"><a href="#" class="datatable-sorter">Address</a></th>
                                    <th data-sortable="true"><a href="#" class="datatable-sorter">Birthday</a></th>
                                    <th data-sortable="true"><a href="#" class="datatable-sorter">Email</a></th>
                                    <th data-sortable="true"><a href="#" class="datatable-sorter">Password</a></th>
                                    <th data-sortable="true"><a href="#" class="datatable-sorter">Role</a></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                <tr data-index="0">
                                    ...
                                    <td><?= $user['client_phone_num'] ?></td>
                                    <td><?= $user['client_address'] ?></td>
                                    <td><?= $user['client_birthday'] ?></td>
                                    <td><?= $user['email'] ?></td>
                                    <td><?= $user['password'] ?></td>
                                    <td><?= $user['role'] ?></td>
                                </tr>
